...
var MenuBurger = /*#__PURE__*/function () {
  ...
  _createClass(MenuBurger, [{
    ...
    value: function changeImg() {
      ...
      for (var i = 0; i < this.imgContainer.children.length; i++) {
...
function HashNavigation({
  ...
  const onHashChange = () => {
    ...
    const activeSlideEl = swiper.slidesEl.querySelector("[data-swiper-slide-index=\"".concat(swiper.activeIndex, "\"]"));
...
},{}],"levina/img/shoes.png":[function(require,module,exports) {
module.exports = "/shoes.33bf8731.png";
},{}],"levina/img/smile.png":[function(require,module,exports) {
module.exports = "/smile.85e1f966.png";
},{}],"levina/img/ultrafiolet.png":[function(require,module,exports) {
module.exports = "/ultrafiolet.d316183e.png";
},{}],"components/workWithUs/larionovImg/michael.png":[function(require,module,exports) {
module.exports = "/michael.47c25e44.png";
},{}],"components/workWithUs/larionovImg/uglyGuy.png":[function(require,module,exports) {
module.exports = "/uglyGuy.0b576bd6.png";
},{}],"components/workWithUs/larionovImg/singingAfro.png":[function(require,module,exports) {
module.exports = "/singingAfro.4e5296ba.png";
},{}],"components/workWithUs/belovImg/guitar.png":[function(require,module,exports) {
module.exports = "/guitar.f27d9389.png";
},{}],"components/workWithUs/belovImg/crazy.png":[function(require,module,exports) {
module.exports = "/crazy.b8f416f1.png";
},{}],"components/workWithUs/belovImg/perfectGuy.png":[function(require,module,exports) {
module.exports = "/perfectGuy.a36bb3be.png";
...
var _firstLoginova = _interopRequireDefault(require("./img/firstLoginova.png"));
var _secondLoginova = _interopRequireDefault(require("./img/secondLoginova.png"));
var _thirdLoginova = _interopRequireDefault(require("./img/thirdLoginova.png"));
var _Vector = _interopRequireDefault(require("./img/Vector.svg"));
var _shoes = _interopRequireDefault(require("../../levina/img/shoes.png"));
var _smile = _interopRequireDefault(require("../../levina/img/smile.png"));
var _ultrafiolet = _interopRequireDefault(require("../../levina/img/ultrafiolet.png"));
var _michael = _interopRequireDefault(require("../workWithUs/larionovImg/michael.png"));
var _uglyGuy = _interopRequireDefault(require("../workWithUs/larionovImg/uglyGuy.png"));
var _singingAfro = _interopRequireDefault(require("../workWithUs/larionovImg/singingAfro.png"));
var _guitar = _interopRequireDefault(require("../workWithUs/belovImg/guitar.png"));
var _crazy = _interopRequireDefault(require("../workWithUs/belovImg/crazy.png"));
var _perfectGuy = _interopRequireDefault(require("../workWithUs/belovImg/perfectGuy.png"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
_swiper.default.use([_swiper.Navigation, _swiper.Autoplay, _swiper.EffectFade]);
var MySwiper = /*#__PURE__*/function () {
  ...
  _createClass(MySwiper, [{
    ...
    value: function open() {
      var _this = this;
      var swiperInits = document.querySelectorAll('._start-slider');
      var _iterator = _createForOfIteratorHelper(swiperInits),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          elem.addEventListener('click', function (event) {
            if (event.target.closest('[data-loginova="true"]')) {
              _this.render(_firstLoginova.default, _secondLoginova.default, _thirdLoginova.default);
            } else if (event.target.closest('[data-levina="true"]')) {
              _this.render(_shoes.default, _smile.default, _ultrafiolet.default);
            } else if (event.target.closest('[data-larionov="true"]')) {
              _this.render(_michael.default, _uglyGuy.default, _singingAfro.default);
            } else if (event.target.closest('[data-belov="true"]')) {
              _this.render(_guitar.default, _perfectGuy.default, _crazy.default);
            }
            ;
            _this.addInitialization();
    ...
    value: function close() {
      document.addEventListener('click', function (event) {
        ...
        if (target.closest('[data-closer="true"]')) {
          ...
          setTimeout(function () {
            var _iterator2 = _createForOfIteratorHelper(ROOT_SWIPER_LOGINOVAS),
              _step2;
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                var _ROOT_SWIPER_LOGINOVA = _step2.value;
                _ROOT_SWIPER_LOGINOVA.innerHTML = "";
              }
            } catch (err) {
              _iterator2.e(err);
            } finally {
...
exports.default = _default;
},{"swiper":"node_modules/swiper/swiper.esm.js","../../constants/var.js":"constants/var.js","./img/firstLoginova.png":"components/swiper/img/firstLoginova.png","./img/secondLoginova.png":"components/swiper/img/secondLoginova.png","./img/thirdLoginova.png":"components/swiper/img/thirdLoginova.png","./img/Vector.svg":"components/swiper/img/Vector.svg","../../levina/img/shoes.png":"levina/img/shoes.png","../../levina/img/smile.png":"levina/img/smile.png","../../levina/img/ultrafiolet.png":"levina/img/ultrafiolet.png","../workWithUs/larionovImg/michael.png":"components/workWithUs/larionovImg/michael.png","../workWithUs/larionovImg/uglyGuy.png":"components/workWithUs/larionovImg/uglyGuy.png","../workWithUs/larionovImg/singingAfro.png":"components/workWithUs/larionovImg/singingAfro.png","../workWithUs/belovImg/guitar.png":"components/workWithUs/belovImg/guitar.png","../workWithUs/belovImg/crazy.png":"components/workWithUs/belovImg/crazy.png","../workWithUs/belovImg/perfectGuy.png":"components/workWithUs/belovImg/perfectGuy.png"}],"components/feedback/img/close.svg":[function(require,module,exports) {
...
exports.default = _default;
},{"../feedback//img/close.svg":"components/feedback/img/close.svg","../../constants/var":"constants/var.js"}],"libs/youtubeLightbox/youtubeLightbox.js":[function(require,module,exports) {
"use strict";
...
var YoutubeLightbox = /*#__PURE__*/function () {
  ...
  _createClass(YoutubeLightbox, [{
    ...
    value: function connect(youtubelightboxId, youtubelightboxPlayer, youtubelightboxCenteredChild) {
      ...
      youtubelightbox.querySelector(youtubelightboxCenteredChild).addEventListener('click', function (e) {
        e.stopPropagation();
      }, false);
...
exports.default = _default;
},{}],"components/loginovaDetail/LoginovaDetail.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../libs/youtubeLightbox/youtubeLightbox":"libs/youtubeLightbox/youtubeLightbox.js"}],"components/workWithUs/larionov/larionov.js":[function(require,module,exports) {
"use strict";
...
},{"../../menuBurger/MenuBurger":"components/menuBurger/MenuBurger.js","../../swiper/swiper":"components/swiper/swiper.js","../../feedback/Feedback":"components/feedback/Feedback.js","../../loginovaDetail/LoginovaDetail":"components/loginovaDetail/LoginovaDetail.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/workWithUs/larionov/larionov.js"], null)
//# sourceMappingURL=/larionov.e772efcd.js.map